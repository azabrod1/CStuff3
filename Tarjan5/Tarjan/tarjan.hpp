...
public:
    ...
    static SCC_Set* multiThreadedTarjan(const Graph<Vid>& _graph, Vid num_threads = 4, DictType dType =  Sharded_SpinLock){
        
        Dictionary<Vid, Cell<Vid>* >* dict = DictionaryFactory::getDictionary<Vid, Cell<Vid>* >(dType);
