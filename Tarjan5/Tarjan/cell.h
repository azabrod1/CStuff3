...
public:
    ...
    Cell(V _vertex) : Cell(),  vertex(_vertex){}
    ...
    inline bool isNew(const int expectedAge){
...
//                neighborQueue.erase(it);
    ...
    inline Reference<Cell<Vid>> getReference(){
        return refCounter.createReference();
    }
